...
export function buildSystemPrompt(personality: Personality, userProfile: string): string {
...
export function buildModePrompt(mode: ChatMode): string {
  return MODE_PROMPTS[mode];
}

// ─────────────────────────────────────────────
// BIHAR AI — TYPES & DETECTION
// ─────────────────────────────────────────────
...
export function normalizeBiharCategory(input: unknown): BiharCategory | null {
  if (typeof input !== "string") return null;
  const v = input.trim().toLowerCase().replace(/-/g, "_");
  if (v === "auto") return null;
  return BIHAR_CATEGORY_LIST.includes(v as BiharCategory) ? (v as BiharCategory) : null;
}
...
export function detectBiharCategoriesFromMessage(text: string): BiharCategory[] {
  ...
  const test = (cat: BiharCategory, re: RegExp) => { if (re.test(t)) found.add(cat); };
...
export function resolvePrimaryBiharCategory(detected: BiharCategory[]): BiharCategory {
...
const BIHAR_CATEGORY_GUIDANCE: Record<BiharCategory, string> = {
...
export const EVARA_MASTER_BASE_PROMPT = "";
export const BASE_SYSTEM_PROMPT = "";
export const UNIVERSAL_INTELLIGENCE_CORE_PROMPT = "";
export const EVARA_FINAL_MASTER_ROLE_PROMPT = "";
export const BIHAR_FINAL_MASTER_ROLE_PROMPT = "";
export const UNIVERSAL_INTELLIGENCE_BOOST_PROMPT = "";
export const EVARA_ULTIMATE_INTELLIGENCE_PROMPT = "";
export const EVARA_ANTI_BREAK_MASTER_PROMPT = "";
export const EVARA_CLEAN_FINAL_MASTER_PROMPT = "";
export const EVARA_MASTER_BRAIN = "";
export const SIMI_PROMPT_LAYER = "";
export const LOA_PROMPT_LAYER = "";
export const EVARA_PERSONALITY_CONTRAST_RULES = "";
export const EVARA_AUTO_INTENT_MOOD = "";
export const EVARA_AUTO_PERSONALITY_ADAPTATION = "";
export const EVARA_MEMORY_RULES = "";
export const EVARA_CONTINUITY_RULES = "";
export const AUTO_MODE_INTELLIGENCE = "";
export const EVARA_NATURAL_RESPONSE_ENGINE = "";
export const EVARA_COGNITIVE_EXCELLENCE_STACK = "";
export const EVARA_FOLLOWUP_ENGINE = "";
export const EVARA_SAFETY_RULES = "";
export const EVARA_MULTILINGUAL_ADAPTATION = "";
export const BIHAR_MASTER_BASE_PROMPT = "";
export const BIHAR_COGNITIVE_EXCELLENCE_STACK = "";
export const BIHAR_EXTRA_INTELLIGENCE_RULES = "";
...
export function buildBiharDistrictContextAddon(_district: string): string { return ""; }
export function buildBiharWebModeAddon(_webSearchEnabled: boolean): string { return ""; }
