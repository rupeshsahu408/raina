...
- Inbox AI dashboard at `/inbox/dashboard` is a three-pane layout (thread list | email view | AI reply panel) with a Gmail-synced compose panel for new outbound emails. Intent labels: Lead/Support/Payment/Meeting/FYI/Spam. Reply tones: Formal/Casual/Sales/Empathetic/Short.
