    ...
    <div className="flex items-center gap-2 rounded-2xl border border-white/[0.09] bg-[#1a1a1a] px-3 py-3 shadow-xl">
      ...
      <div className="flex items-center gap-1.5 shrink-0 pl-2 border-l border-white/[0.08]">
        <button
          ...
          title="Cancel"
          className="flex h-8 w-8 items-center justify-center rounded-full border border-white/[0.1] text-zinc-400 transition hover:border-white/20 hover:text-zinc-100 disabled:opacity-40"
        >
