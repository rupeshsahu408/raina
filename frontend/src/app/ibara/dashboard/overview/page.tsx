        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              {
                label: "Language",
                value: bot?.language ? <span className="capitalize font-semibold">{bot.language}</span> : <span className="text-white/20">–</span>,
                icon: "🗣️",
          ...
          <div className="card-glass rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-violet-300 group-hover:text-violet-200 transition-colors">Configure AI</p>
                  <p className="text-xs text-white/30 mt-0.5">Set up your chatbot personality and knowledge</p>
                </div>
              </button>
              <button
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-white/30 mt-0.5">Preview how your AI responds to visitors</p>
                </div>
              </button>
              <button
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-white/30 mt-0.5">Connect another domain to IBARA AI</p>
                </div>
              </button>
            </div>
          </div>
