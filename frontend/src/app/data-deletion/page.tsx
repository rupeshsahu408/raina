      ...
      <header className="border-b border-zinc-100 bg-white px-4 py-4 sm:px-6">
        <div className="mx-auto flex max-w-4xl items-center justify-between">
          <a href="/whatsapp-ai" className="flex items-center gap-2">
            <img src="/evara-logo.png" alt="Raina Jet" className="h-7 w-7 rounded-md bg-black p-0.5 object-contain" draggable={false} />
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10">
          <section>
            ...
            <div className="mt-5 space-y-3 text-base leading-relaxed text-zinc-600">
              <p>When you use the Raina Jet platform — either as a business owner connecting your WhatsApp account, or as an end customer interacting with a business through WhatsApp — we may store the following types of data:</p>
              ...
              <ol className="mt-3 list-decimal space-y-3 pl-5">
                ...
                <li>
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5">
                    ...
                    <li>The email address associated with your Raina Jet account.</li>
          ...
          <section>
            ...
            <div className="mt-5 space-y-3 text-base leading-relaxed text-zinc-600">
              <p>
                If you connected your WhatsApp Business account to Raina Jet through the WhatsApp Cloud API provided by Meta Platforms, Inc., please be aware that certain data may also be held directly by Meta. Raina Jet can only delete the data held within our own systems. To request deletion of data held by Meta, please refer to{" "}
              ...
              <p>This data deletion page specifically covers data held by Raina Jet on our own servers and databases.</p>
            </div>
          </section>

          <section>
            <h2 className="border-b border-zinc-100 pb-3 text-2xl font-bold text-zinc-900">7. Contact Us</h2>
            <div className="mt-5 text-base leading-relaxed text-zinc-600">
              ...
              <div className="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-6">
                <p className="font-semibold text-zinc-900">Raina Jet — Data Privacy Team</p>
                ...
                <p className="mt-3 text-sm text-zinc-500">We aim to acknowledge all requests within 48 hours and complete deletion within 7 business days of verification.</p>
              </div>
            </div>
          </section>
        </div>
