...
export const metadata: Metadata = {
  title: "Disclaimer — Evara AI",
  description:
    "Legal Disclaimer for Evara AI, covering AI output limitations, professional advice disclaimers, WhatsApp AI integration responsibilities, and liability limitations.",
};
          ...
          <article className="rounded-[2rem] border border-gray-200 bg-white p-5 shadow-2xl shadow-gray-100 backdrop-blur-2xl sm:p-8 lg:p-10">
            ...
            <div className="policy-content mt-10 space-y-12">
              ...
              <DisclaimerSection id="general-disclaimer" title="1. General Disclaimer">
                ...
                <p>
                  The operation of the Evara AI platform depends on a variety of factors outside our direct control, including but not limited to third-party AI model providers, cloud hosting infrastructure, internet connectivity, device compatibility, regulatory requirements, and third-party API availability. Evara AI does not guarantee uninterrupted, error-free, or perfectly accurate operation at all times. Users access and use the platform at their own risk, subject to the terms of this Disclaimer and any applicable terms of service or other agreements between the user and Evara AI.
                </p>
                <p>
                  Nothing contained within the Evara AI platform, its outputs, its documentation, its communications, its marketing materials, or any other materials associated with Evara AI constitutes a warranty, guarantee, or representation that the services will meet your specific expectations, requirements, or standards. Evara AI expressly disclaims any and all implied warranties to the fullest extent permitted by applicable law.
                </p>
              </DisclaimerSection>

              <DisclaimerSection id="ai-output-disclaimer" title="2. AI Output Disclaimer">
                <p>
                  The artificial intelligence systems integrated within the Evara AI platform are designed to generate text-based responses, suggestions, summaries, classifications, automated replies, and other forms of AI-generated output based on user inputs, configured instructions, and underlying language model capabilities. While significant effort is made to ensure that AI outputs are helpful, relevant, and coherent, the nature of AI-generated content is inherently probabilistic and subject to significant limitations.
                </p>
              ...
              <DisclaimerSection id="whatsapp-ai-disclaimer" title="5. WhatsApp AI Disclaimer">
                <p>
                  WhatsApp AI is a business automation service provided by Evara AI that enables business customers to integrate AI-powered messaging automation with the WhatsApp Business API, operated by Meta Platforms, Inc. The following specific disclaimers apply to your use of WhatsApp AI and any operations conducted through it.
                </p>
                <SubSection title="5.1 Integration with WhatsApp Business API">
                  <p>
                    WhatsApp AI operates through the WhatsApp Business API, which is a third-party service provided by Meta Platforms, Inc. The availability, functionality, performance, pricing, terms, permissions, message limits, template approval processes, and policy requirements of the WhatsApp Business API are controlled exclusively by Meta. Evara AI does not own, operate, or control the WhatsApp platform, the WhatsApp Business API, or any Meta infrastructure, and the provision of WhatsApp AI features is contingent upon the continued availability and operation of Meta's systems.
                  </p>
                </SubSection>
                <SubSection title="5.2 Dependency on Meta and Third-Party Platforms">
                  <p>
                    Because WhatsApp AI depends fundamentally on Meta's infrastructure and policies, Evara AI cannot guarantee the continuous, uninterrupted, or error-free availability of WhatsApp AI features. Users acknowledge and accept that:
                  </p>
                  <ul>
                    <li>WhatsApp service outages, maintenance windows, degraded performance, API rate limiting, or infrastructure disruptions caused by Meta are entirely outside the control of Evara AI and do not constitute a failure or breach by Evara AI.</li>
                    <li>API limitations imposed by Meta, including but not limited to message delivery limits, template restrictions, media restrictions, phone number policies, and account verification requirements, may affect the functionality of WhatsApp AI in ways that Evara AI cannot override, circumvent, or mitigate.</li>
                    <li>Policy changes made by Meta, including changes to WhatsApp Business API terms, messaging policies, data processing requirements, commerce policies, acceptable use policies, or developer platform terms, may require changes to or suspension of WhatsApp AI features without prior notice, and Evara AI shall not be liable for any resulting disruption.</li>
                    <li>Account suspensions, restrictions, or bans applied by Meta to a business's WhatsApp Business account are not within the control of Evara AI and do not give rise to any liability on the part of Evara AI.</li>
                  </ul>
                </SubSection>
                <SubSection title="5.3 User Responsibilities for WhatsApp AI">
                  <p>
                    Business customers using WhatsApp AI assume full and sole responsibility for the following:
                  </p>
                  <ul>
                    <li><strong>Customer Consent:</strong> Obtaining all legally required consents, opt-ins, permissions, and authorizations from end customers prior to initiating, automating, or otherwise conducting messaging through WhatsApp AI. This includes compliance with applicable telecommunications laws, anti-spam regulations, consumer protection laws, and the WhatsApp Business Policy.</li>
                    <li><strong>Lawful Communication:</strong> Ensuring that all messages, content, responses, templates, media, and communications transmitted through WhatsApp AI are lawful, accurate, non-deceptive, non-harassing, and compliant with all applicable laws and regulations in the jurisdictions where recipients are located.</li>
                    <li><strong>Compliance with WhatsApp Policies:</strong> Reading, understanding, and complying fully with all applicable Meta and WhatsApp policies, including the WhatsApp Business Policy, Meta Platform Terms, WhatsApp Commerce Policy, and any additional terms applicable to the WhatsApp Business API. Evara AI does not accept liability for any policy violations committed by business customers through their use of WhatsApp AI.</li>
                    <li><strong>Human Oversight:</strong> Maintaining appropriate human oversight over AI-generated automated replies, particularly where such replies may affect customer rights, purchases, complaints, financial obligations, or other sensitive matters. Business customers may not use WhatsApp AI as a substitute for required human judgment in regulated or high-stakes contexts.</li>
                  </ul>
                </SubSection>
                <SubSection title="5.4 No Liability for WhatsApp-Related Failures">
                  <p>
                    Evara AI shall not be liable for any loss, claim, damage, disruption, regulatory sanction, customer complaint, reputational harm, or business consequence arising from or related to the unavailability, performance degradation, policy enforcement, or technical limitations of the WhatsApp Business API, Meta's infrastructure, or Meta's independent processing of data. Such risks are inherent to the use of a third-party communication platform and are accepted by users as a condition of using WhatsApp AI.
                  </p>
                </SubSection>
              </DisclaimerSection>
              ...
              <DisclaimerSection id="third-party-disclaimer" title="6. Third-Party Disclaimer">
                <p>
                  The Evara AI platform may incorporate, depend upon, or provide access to a range of third-party services, integrations, APIs, providers, libraries, hosting infrastructure, and other external systems. These include but are not limited to cloud hosting providers, AI model providers, content delivery networks, authentication providers, analytics tools, payment processors, messaging platforms, and business productivity integrations.
                </p>
                <SubSection title="6.1 No Control Over Third-Party Services">
                  <p>
                    Evara AI does not own, operate, control, or assume responsibility for any third-party service, platform, or infrastructure integrated with or used in connection with the Evara AI platform. Third-party services operate independently and are governed by their own terms of service, privacy policies, data processing agreements, acceptable use policies, and applicable laws. Evara AI cannot guarantee the availability, performance, accuracy, security, compliance, or lawfulness of any third-party service.
                  </p>
                </SubSection>
                <SubSection title="6.2 No Liability for Third-Party Failures">
                  <p>
                    Evara AI shall not be liable for any failure, outage, error, security breach, data loss, unauthorized access, policy change, pricing change, discontinuation, or other adverse event caused by or arising from a third-party service provider, regardless of whether such provider is identified to users or whether users interact with such provider directly. Users acknowledge that reliance on a platform that integrates with third-party services inherently carries risks associated with the availability and behavior of those services.
                  </p>
                </SubSection>
                <SubSection title="6.3 Third-Party Data Handling">
                  <p>
                    Where user data is processed by or transmitted to third-party providers in connection with the operation of the Evara AI platform, such processing is subject to the privacy practices and data protection commitments of those providers. Evara AI is not responsible for the data handling practices, privacy policies, security measures, or regulatory compliance posture of any third-party provider. Users are encouraged to review the terms and privacy policies of any third-party service they interact with in connection with the Evara AI platform.
                  </p>
                </SubSection>
              </DisclaimerSection>
              ...
              <DisclaimerSection id="limitation-of-liability" title="7. Limitation of Liability">
                <p>
                  To the fullest extent permitted by applicable law, Evara AI, its officers, directors, employees, contractors, agents, licensors, suppliers, successors, and assigns shall not be liable to any user or third party for any damages of any kind arising from or related to the use of, inability to use, or reliance upon the Evara AI platform, its content, its AI outputs, or any related services.
                </p>
                <SubSection title="7.1 Categories of Excluded Liability">
                  <p>Without limiting the generality of the foregoing, Evara AI expressly excludes all liability for:</p>
                  <ul>
                    ...
                    <li><strong>Security Incidents:</strong> Any loss, harm, or damage arising from unauthorized access, data breaches, phishing attacks, account compromise, or other security incidents that are not directly caused by Evara AI's own gross negligence or willful misconduct.</li>
                  </ul>
                </SubSection>
                <SubSection title="7.2 Use at User's Own Risk">
                  <p>
                    The use of the Evara AI platform and all its services is entirely at the user's own risk. Users acknowledge that AI-powered platforms involve inherent uncertainties, technical limitations, and operational dependencies that cannot be fully eliminated. By accessing and using the platform, users accept these risks and waive any claims against Evara AI arising from them to the fullest extent permissible under applicable law.
                  </p>
                </SubSection>
              ...
              <DisclaimerSection id="no-guarantees" title="8. No Guarantees">
                <p>
                  Evara AI expressly disclaims any and all guarantees, warranties, commitments, or assurances regarding the performance, availability, accuracy, or continuity of the platform and its services, except as may be set out in a separate written agreement between Evara AI and a specific customer.
                </p>
                <ul>
                  <li>
                    <strong>Service Uptime:</strong> Evara AI does not guarantee any specific level of service uptime, availability, or operational continuity. The platform may be subject to planned or unplanned downtime due to maintenance, infrastructure failures, security incidents, third-party outages, or other operational requirements. Any uptime or availability metrics shared informally or in marketing materials are targets only and do not constitute binding commitments.
                  </li>
                  <li>
                    <strong>Accuracy of AI Outputs:</strong> As described in detail in Section 2 of this Disclaimer, Evara AI makes no guarantee regarding the accuracy, completeness, or correctness of any AI-generated output. AI systems are inherently probabilistic, and their outputs should not be treated as authoritative or definitive without independent verification.
                  </li>
                  <li>
                    <strong>Continuous Availability:</strong> Evara AI does not guarantee that all features, integrations, or capabilities of the platform will remain continuously available. Features may be added, modified, temporarily suspended, or permanently discontinued at any time, with or without prior notice, based on business, technical, legal, or operational considerations.
                  </li>
                  <li>
                    <strong>Response Times:</strong> Evara AI does not guarantee specific response times for AI queries, API requests, customer support inquiries, or platform operations. Performance may vary based on server load, network conditions, input complexity, and other factors.
                  </li>
                  <li>
                    <strong>Integration Reliability:</strong> Evara AI does not guarantee the continuous, error-free operation of any third-party integration, including the WhatsApp Business API, authentication providers, AI model providers, or other external services upon which the platform depends.
                  </li>
                </ul>
              </DisclaimerSection>
              ...
              <DisclaimerSection id="external-links-disclaimer" title="9. External Links Disclaimer">
                <p>
                  The Evara AI platform, its documentation, its support resources, and its AI-generated outputs may from time to time contain hyperlinks, references, or citations to external websites, resources, articles, services, tools, or other third-party digital content. These links are provided for informational and convenience purposes only and do not constitute an endorsement, sponsorship, recommendation, verification, or approval by Evara AI of the linked content, organization, product, or service.
                </p>
                <p>
                  Evara AI does not control, monitor, review, or maintain any external website or third-party content linked from the platform. External websites may contain information, viewpoints, products, services, or practices that differ from or conflict with those of Evara AI, and Evara AI accepts no responsibility for the accuracy, legality, safety, completeness, or appropriateness of any externally linked content. Accessing external links from the Evara AI platform is entirely at the user's own risk.
                </p>
                <p>
                  Evara AI shall not be liable for any loss, harm, damage, or adverse experience arising from the user's access to, use of, or reliance upon any external website or third-party resource linked from the platform. The inclusion of a hyperlink in any platform interface, document, or AI-generated output does not imply that Evara AI has reviewed, validated, or takes responsibility for the linked destination.
                </p>
              </DisclaimerSection>
              ...
              <DisclaimerSection id="brand-independence-statement" title="10. Brand Independence Statement">
                ...
                <p>
                  Evara AI operates as a fully independent artificial intelligence software company. It has not been licensed, authorized, endorsed, or approved by vercal.com or any related entity, and no relationship — whether commercial, legal, technological, or organizational — exists between Evara AI and vercal.com or any entity bearing a similar name. Users should not interpret any similarity in naming as implying any form of relationship, affiliation, or collaboration between these entities.
                </p>
                <p>
                  Evara AI is its own distinct platform, brand, and legal entity with its own independent products, services, team, intellectual property, terms of service, privacy practices, and operational infrastructure. Any representations suggesting a connection between Evara AI and vercal.com or similarly named entities are unauthorized, inaccurate, and not reflective of any actual relationship.
                </p>
                <p>
                  If you have encountered any communication, advertisement, content, or representation that incorrectly suggests a connection between Evara AI and vercal.com or any similarly named entity, please contact us immediately at the email address provided in Section 13 of this Disclaimer so that we may investigate and address the matter appropriately.
                </p>
              </DisclaimerSection>

              <DisclaimerSection id="user-responsibility" title="11. User Responsibility">
                <p>
                  By accessing and using the Evara AI platform and its services, each user accepts full personal and, where applicable, organizational responsibility for their conduct, their use of the platform, the content they submit, the AI outputs they act upon, and the downstream consequences of their decisions and actions. The following responsibilities apply to all users of the platform:
                </p>
                <ul>
                  <li>
                    <strong>Legal Compliance:</strong> Users are solely responsible for ensuring that their use of the Evara AI platform, including all content submitted, messages sent, automations configured, and AI outputs acted upon, complies with all applicable laws, regulations, industry standards, professional codes of conduct, and contractual obligations in every jurisdiction relevant to their operations or communications.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Platform Misuse:</strong> Users must not engage in activities that interfere with, disrupt, overload, or compromise the integrity, security, or availability of the Evara AI platform or any associated infrastructure. Any attempt to reverse-engineer, exploit, scrape, or circumvent platform protections is strictly prohibited and may result in immediate account suspension and legal action.
                  </li>
                </ul>
                <p>
                  Evara AI reserves the right to suspend or terminate access to the platform for any user who violates these responsibilities, engages in unlawful conduct, misuses the platform, or poses a risk to other users or the integrity of the platform, without prior notice and without liability.
                </p>
              </DisclaimerSection>

              <DisclaimerSection id="changes-to-this-disclaimer" title="12. Changes to This Disclaimer">
                <p>
                  Evara AI reserves the right to update, amend, supplement, or replace this Disclaimer at any time and for any reason, including to reflect changes in our services, practices, legal requirements, third-party dependencies, or operational policies. Any changes will be effective upon the posting of the revised Disclaimer to the Evara AI platform, with the updated effective date indicated at the top of this document.
                </p>
                <p>
                  Where changes to this Disclaimer are material or significantly affect user rights or platform responsibilities, Evara AI may provide advance notice through the platform interface, via email notification to registered account holders, or through other reasonable communication methods. However, Evara AI is not obligated to provide advance notice of all changes, and the absence of notice does not affect the validity or enforceability of any revised Disclaimer.
                </p>
                <p>
                  Your continued access to or use of the Evara AI platform following the posting of any revised Disclaimer constitutes your acknowledgment of the updated terms and your agreement to be bound by them. If you do not agree with any changes made to this Disclaimer, you must immediately discontinue your use of the platform and, if applicable, close your account. Continued use of the platform after the effective date of any revision confirms your acceptance of the revised terms.
                </p>
                <p>
                  Evara AI recommends that users periodically review this Disclaimer to remain informed of any updates. Archived versions of prior Disclaimer documents may be made available upon reasonable request.
                </p>
              </DisclaimerSection>
