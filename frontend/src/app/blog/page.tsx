    ...
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-purple-500/30">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 pt-28 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-purple-400/20 bg-purple-400/10 px-5 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-purple-300 mb-6">
        ...
        {/* Featured Post */}
        {featuredPost && (
          <article className="group mb-14 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] backdrop-blur-xl transition-all hover:border-white/20 hover:bg-white/[0.06]">
            <div className="grid lg:grid-cols-[1fr_420px]">
              <div className="p-8 sm:p-10 lg:p-12">
                ...
                <p className="mt-4 text-base leading-8 text-zinc-400 max-w-2xl">{featuredPost.excerpt}</p>
                <div className="mt-6 flex flex-wrap items-center gap-4 text-xs text-zinc-500">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-zinc-400">{featuredPost.author}</span>
                  </div>
                  <span>·</span>
              ...
              <div className="flex items-center justify-center border-t border-white/5 bg-white/[0.02] p-8 lg:border-t-0 lg:border-l">
                <div className="space-y-3 w-full">
                  ...
                  <div className="mt-6 pt-6 border-t border-white/5">
                    <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-600 mb-3">Author</p>
                    <div className="flex items-center gap-3">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <span className="text-xs text-zinc-500">{regularPosts.length} articles</span>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {regularPosts.map((post) => {
            ...
            return (
              <article
                key={post.slug}
                className="group flex flex-col rounded-[1.5rem] border border-white/10 bg-white/[0.04] backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:border-white/20 hover:bg-white/[0.06] hover:shadow-xl"
              >
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-5 pt-5 border-t border-white/5 flex items-center justify-between">
                    ...
                    <Link
                      href={`/blog/${post.slug}`}
                      className="flex items-center gap-1 text-xs text-purple-400 transition hover:text-purple-300 font-semibold"
                    >
                      Read
        ...
        <div className="mt-20 mb-6">
          ...
          <p className="mt-1 text-sm text-zinc-500">Find articles specific to your interests and use case</p>
        </div>
          ...
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-1 text-xs leading-5 text-zinc-500">{cat.description}</p>
        ...
        <div className="mt-20 relative overflow-hidden rounded-[2rem] border border-purple-500/20 bg-purple-500/[0.06] p-10 backdrop-blur-xl text-center">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 rounded-full border border-purple-400/20 bg-purple-400/10 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-purple-300 mb-5">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link href="/signup" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
                Try Evara AI Free
              </Link>
            </div>
          </div>
