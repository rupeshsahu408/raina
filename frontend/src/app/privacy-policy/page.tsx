...
const tableOfContents = [
  ...
  ["Evara AI Specific Privacy", "evara-ai-specific-privacy"],
  ...
  ["Inbox AI Data Retention and Deletion", "inbox-ai-data-retention"],
            ...
            <div className="policy-content mt-10 space-y-12">
              ...
              <PolicySection id="information-we-collect" title="3. Information We Collect">
                ...
                <SubSection title="3.2 Business Information">
                  <p>For business users, especially users configuring WhatsApp AI or Plyndrox Inbox AI for business purposes, we may collect business-related information, including:</p>
                  <ul>
                ...
                <SubSection title="3.4 AI Interaction Data">
                  <p>When you use AI functionality, including Evara AI, AI-powered automations within WhatsApp AI, or AI Inbox Analysis within Plyndrox Inbox AI, we may process:</p>
                  <ul>
              ...
              <PolicySection id="how-we-use-information" title="4. How We Use Information">
                ...
                <ul>
                  ...
                  <li><strong>Operating Plyndrox Inbox AI:</strong> To access Gmail data through the authorized Gmail Integration, apply AI Inbox Analysis to email content and metadata, generate summaries, classify intent, detect sentiment, score priorities, surface leads, identify follow-ups, generate smart replies, and display analytical outputs in your Inbox AI dashboard — all exclusively for your own use and account.</li>
              ...
              <PolicySection id="gmail-oauth-and-google-api-data" title="8. Gmail OAuth and Google API Data">
                ...
                <SubSection title="8.2 OAuth Token Storage and Security">
                  ...
                  <p>
                    Refresh tokens are used solely to obtain new access tokens when they expire, allowing the Inbox AI service to continue operating between your active sessions without requiring you to re-authorize frequently. We do not use refresh tokens for any purpose other than refreshing access tokens for Inbox AI functionality.
                  </p>
                </SubSection>
                <SubSection title="8.3 Gmail API Scope Restrictions">
                  <p>
                    We access only the Gmail API data permitted by the scopes you have granted. We do not access Google Drive, Google Calendar, Google Contacts, Google Workspace admin functions, or any other Google service beyond what is authorized. If future Inbox AI features require access to additional Google services, we will request those permissions separately and clearly identify what new access is being requested before you grant it.
                  </p>
                </SubSection>
                <SubSection title="8.4 Compliance with Google API Services User Data Policy">
                  ...
                  <ul>
                    ...
                    <li>We do not transfer Gmail data to third parties except as necessary to provide and improve the Inbox AI service, in compliance with applicable law, and only to processors who are bound by confidentiality obligations.</li>
              ...
              <PolicySection id="email-content-processing" title="9. Email Content Processing and AI Analysis">
                <p>
                  This section explains in detail how email content is fetched, transmitted, processed by AI systems, stored, and presented back to you through the Plyndrox Inbox AI dashboard. Understanding this pipeline is important for evaluating the privacy implications of using Inbox AI features.
                </p>
                <SubSection title="9.1 Email Fetching and Synchronization">
                  <p>
                    When you access Inbox AI features, our backend systems use your authorized OAuth Token to make API calls to the Gmail API on your behalf. Depending on the feature, this may involve fetching full message content, fetching only message headers and metadata, listing threads or labels, or searching messages based on specific criteria such as date range, sender, or label. Email data is fetched over encrypted HTTPS connections directly from Google's API servers.
                  </p>
                  <p>
                ...
                <SubSection title="9.3 Storage of Processed Email Data">
                  <p>
                    For the Inbox AI service to function effectively — including enabling you to view your smart digest, revisit analyzed emails, and access historical prioritization scores — we store certain Email Content Data and AI Inbox Analysis outputs in our database. This stored data is associated with your account and is not shared with other users.
                  </p>
                  <p>
              ...
              <PolicySection id="data-retention" title="13. General Data Retention">
                ...
                <ul>
                  ...
                  <li><strong>WhatsApp AI chat logs:</strong> Retained to provide dashboard history, support business review, troubleshoot automation, and satisfy legal or compliance requirements.</li>
                  <li><strong>Inbox AI data:</strong> Retained as described in Section 11, with deletion initiated upon disconnection or account deletion.</li>
              ...
              <PolicySection id="user-rights" title="15. User Rights">
                ...
                <ul>
                  ...
                  <li><strong>Deletion:</strong> You may request deletion of Personal Data, including Inbox AI data, subject to legal, contractual, security, backup, and operational limitations. See Section 11 for Inbox AI-specific deletion practices.</li>
                  ...
                  <li><strong>Withdraw consent and disconnect:</strong> You may withdraw your consent to Gmail data processing at any time by disconnecting the Gmail Integration through the Inbox AI settings or by revoking access through your Google Account. This will stop further data collection, though data already processed will be subject to our retention and deletion practices.</li>
              ...
              <PolicySection id="cookies-and-tracking" title="16. Cookies and Tracking">
                ...
                <ul>
                  <li><strong>Essential technologies:</strong> Required for login, security, session management, fraud prevention, preferences, and core platform functionality, including maintaining your Inbox AI connection state.</li>
              ...
              <PolicySection id="changes-to-this-policy" title="19. Changes to This Privacy Policy">
                <p>
                  We may update this Privacy Policy from time to time to reflect changes in our Services, technology, legal requirements, business practices, integrations, security measures, or data processing activities — including material changes to how Plyndrox Inbox AI handles Gmail data. When we make material changes, particularly to sections governing Gmail data, we will provide prominent notice through the Inbox AI dashboard, by email to your registered address, through account notifications, or by other reasonable means, and we may require you to re-acknowledge the updated Policy before continuing to use Inbox AI features.
                </p>
                <p>
                  The "Last updated" date at the top of this Privacy Policy indicates when it was last revised. For Inbox AI users specifically, we will not materially expand our use of Gmail data in ways that go beyond what you authorized without seeking your explicit re-consent. If you do not agree to an updated Policy as it applies to Inbox AI, you should disconnect your Gmail account from Plyndrox Inbox AI before the updated Policy takes effect.
                </p>
              </PolicySection>
